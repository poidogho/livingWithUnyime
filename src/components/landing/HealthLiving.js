...
class HealthLiving extends Component {
  render() {
    return (
        ...
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            ...
            <p>
              ...
              Sugar, Reduce Blood Pressure and Much More.
            </p>
          </div>
          ...
          >
            ...
            <li data-filter=".filter-app">Morning</li>
            <li data-filter=".filter-card">Afternoon</li>
            <li data-filter=".filter-web">Night</li>
          </ul>
          ...
          >
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-img">
                <img src="assets/img/cup.jpeg" class="img-fluid" alt="" />
              </div>
              <div class="portfolio-info">
                <h4>Cup of Smoothie</h4>
                <p>Smoothie</p>
                <a
                  href="assets/img/cup.jpeg"
